...
public class KafkaConsumerRegistryController {
    ...
    public void createConsumer(@RequestParam(name = "topic") String topic, @RequestParam(name = "listener") String listenerClass,
                               @RequestParam(required = false, name = "startImmediately") boolean startImmediately) {
